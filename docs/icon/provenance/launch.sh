...
export DISPLAY=:205
export ALSOFT_CONF="/home/thomas/01_TM/Coding/Websites/brainage04.github.io/.local-icon-variants/round3/captures-dimension5/runtime/alsoft.conf"
export PULSE_SINK=round3_dimension5
export LIBGL_ALWAYS_SOFTWARE=1
export LP_NUM_THREADS=2
export MESA_GLTHREAD=false
export OMP_NUM_THREADS=2
exec /nix/store/b7hzgfqk2jfcbncp0vpabf73j0riqgq4-openjdk-25.0.4.1+1/bin/java "@/home/thomas/01_TM/Coding/Websites/brainage04.github.io/.local-icon-variants/round3/captures-dimension5/client.args"
